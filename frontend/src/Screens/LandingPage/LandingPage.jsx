        ...
        <div className="sm:text-center ">
          ...
          <div className="mt-5 sm:mt-8 sm:flex sm:justify-center ">
            ...
            <Link to="/signup" className="mt-3 sm:mt-0 sm:ml-3">
              <div className="w-full flex items-center justify-center px-8 py-2 border border-transparent text-base font-medium rounded-md text-indigo-700 bg-indigo-100 hover:bg-indigo-200 md:py-3 md:text-lg md:px-10">
                Register
              </div>
            </Link>
          </div>
